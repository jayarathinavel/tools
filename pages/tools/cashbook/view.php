            ...
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-2">
                ...
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-2 align-items-stretch">
                        <div class="p-2 rounded bg-light text-success text-center flex-fill" style="min-width:140px;">
                        ...
                        <div class="p-2 rounded bg-light text-danger text-center flex-fill" style="min-width:140px;">
                        ...
                        <div class="p-2 rounded bg-white text-center border flex-fill" style="min-width:120px;">
