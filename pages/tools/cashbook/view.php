        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a class="btn btn-sm btn-primary" href="add.php"><i class="bi bi-plus-lg me-1"></i>Add Entry</a>
                    <a class="btn btn-sm btn-secondary" href="summary.php"><i class="bi bi-list-task me-1"></i>Summary</a>
                    <a class="btn btn-sm btn-info text-white" href="books/view.php"><i class="bi bi-book me-1"></i>Manage Books</a>
                </div>
            </div>
