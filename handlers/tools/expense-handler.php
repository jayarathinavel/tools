<?php
    ...
    if (isset($_POST['id'])) {
        ...
        try {
            ...
            $person = $_POST['person'];
            $date = $_POST['date'];
            executeQuery("UPDATE expense_balance SET expense_name='$expense_name', amount='$amount', person='$person', date='$date' WHERE id=$id");
        ...
        try {
            ...
            executeQuery("INSERT INTO expense_balance (expense_name, amount, person, date, expense_balance_book_id)
